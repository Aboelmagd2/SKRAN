...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Aboelmagd2/SKRAN/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1853574370,1910131222,897897181}   
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'سكران'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
Namebot = (database:get(bot_id..'Name:Bot') or 'سكران')
...
{'𓆩| ıl`𝕊𝕂ℝ𝔸ℕ´lı |𓆪'},
{'ايدي','العاب سكران','سورس','تغير الايدي'},
{'𓆩| ıl`𝕊𝕂ℝ𝔸ℕ´lı |𓆪'},
...
os.execute('wget https://raw.githubusercontent.com/Aboelmagd2/SKRAN/main/AVIRA.lua')
send(msg.chat_id_, msg.id_,'◉ تم تحديث السورس')
dofile('AVIRA.lua')  
end
if text == 'الاصدار ' and sudo2(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس سكران { s: 6.7}')
end
if text == 'ابوالمجد مبرمج السورس' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
...
if text == 'ابوالمجد' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
ℂ𝕆𝔻𝔼ℝ 𝕊𝕆𝕌ℝℂ𝔼  𝕊𝕂ℝ𝔸ℕ 
]] 
...
os.execute('rm -rf AVIRA.lua')
os.execute('wget https://raw.githubusercontent.com/Aboelmagd2/SKRAN/main/AVIRA.lua')
os.execute('wget https://raw.githubusercontent.com/Aboelmagd2/SKRAN/main/library')
os.execute('wget https://raw.githubusercontent.com/Aboelmagd2/SKRAN/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('AVIRA.lua')  
end
...
if text == 'رافت' or text == "رأفت" then
local msg_id = msg.id_/2097152/0.5
local Text = [[
 المبرمج رافت
]]
...
local Text = [[ 
╭━━━━━❲☆[ѕᴋʀᴀɴ ](t.me/ELMAGD3)☆❳━━━━━╮
[𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝚂𝙾𝚄𝚁𝙲𝙴 ѕᴋʀᴀɴ ](t.me/ELMAGD3)
[𝚃𝙷𝙴 𝙱𝙴𝚂𝚃 𝚂𝙾𝚄𝚁𝙲𝙴 𝙾𝙽❳ ❲𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼](t.me/ELMAGD3)
╰━━━━━❲☆[ѕᴋʀᴀɴ ](t.me/ELMAGD3)☆❳━━━━━╯
]]
keyboard = {}
keyboard.inline_keyboard = {
 {{text = '𝔸𝔹𝕆 𝔼𝕃𝕄𝔸𝔾𝔻 𝅘𝅥𝅯',url="t.me/ABO_ELMAGD2"}},
{{text = '𝔻ℝ ℝ𝔸𝔽𝔸𝕋',url="t.me/Dr_Rafaat"}},
{{text = '𝕄ℝ 𝔸𝔹𝔻𝕆',url="t.me/ABNRASHIDYADOLH"}},
{{text = '𝐒𝐨𝐮𝐫𝐜𝐞 𝚂𝙺𝚁𝙰𝙽 ', url="t.me/ELMAGD3"}},
}
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/ELMAGD3/20&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
if text == 'اغاني' or text == 'الاغاني' or text == 'الأغاني' then
local Text = [[
❈The list of music.
]]
keyboard = {} keyboard.inline_keyboard = {
{{text = '🎙️مهرجان "خاينه وبايعه"',url="https://t.me/ELMAGD3/24"}},
{{text = '𖣘⁽𝕄ℝ 𝔸𝔹𝔻𝕆₎𖣘', url="http://t.me/ABNRASHIDYADOLH"}},
{{text = '  𖣘 ⁽𝔸𝔹𝕆 𝔼𝕃𝕄𝔸𝔾𝔻 𝅘𝅥𝅯₎ 𖣘 ',url="t.me/ABO_ELMAGD2"}},
{{text = '  𖣘 ⁽𝔻ℝ ℝ𝔸𝔽𝔸𝕋₎ 𖣘 ',url="t.me/Dr_Rafaat"}}
}
...
local Text = [[
 ◉ اهلا بك في سورس سكران الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ◉ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽𝔸𝔹𝕆 𝔼𝕃𝕄𝔸𝔾𝔻 𝅘𝅥𝅯₎ 𖣘 ',url="t.me/ABO_ELMAGD2"}},
...
if text == '⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ¹❳⊷━━━━⩺' then
local Text = [[ 
◉من أحسن السورسات على التليجرام سورس سكران◉
...
if text == 'العاب سكران' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◉ اهلا في قائمه الالعاب المتطوره سورس سكران  ◉ 
...
if sudo2(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Aboelmagd2/SKRAN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات سكران\n ◉ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
...
local json_file, res = https.request("https://raw.githubusercontent.com/Aboelmagd2/SKRAN/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('AVIRA.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس سكران \n") 
end
return false
end
...
if text == ("مسح قائمه سكران") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه سكران')
return false
end

if text == 'قائمه سكران' and Sudo(msg) then
...
if text == ("رفع سكران") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text and text:match("^رفع سكران @(.*)$") and Sudo(msg) then
local username = text:match("^رفع سكران @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text and text:match("^رفع سكران (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع سكران (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text == ("تنزيل سكران") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text and text:match("^تنزيل سكران @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل سكران @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text and text:match("^تنزيل سكران (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل سكران (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
end --الكود حصري سورس سكران يعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سكران').." غادر" or text == 'غادر' then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سكران').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سكران')
local AVIRA_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سكران')
