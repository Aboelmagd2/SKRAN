...
print('\27[0;35m⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ ¹❳⊷━━━━⩺\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua SCKRAN.lua')
end
...
if [ ! $token ]; then
echo "⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ ¹❳⊷━━━━⩺ ⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ ¹❳⊷━━━━⩺ ┉ ┉"
echo -e "\e[1;36mTOKEN IS NOT FIND IN FILE SKRANInfo.lua \e[0m"
echo "⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ ¹❳⊷━━━━⩺ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉"
exit 1
fi
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./SCKRAN.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("AV", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S SCKRAN -X kill
screen -S SCKRAN ./SCKRAN
done
]])  
file:close() 
...
local f = io.open("./SKRANInfo.lua", "r")  
if not f then   
AutoSet()  
else   
f:close()  
...
local config = loadfile("./SKRANInfo.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
print([[
  ...
  DDDDDDDDDDDDD      EEEEEEEEEEEEEEEEEEEEEESKRANVV           SKRANVVIIIIIIIIIIDDDDDDDDDDDDD        
...
> CH › @ELMAGD3
~> DEVELOPER › @ABO_ELMAGD2 
]])
sudos = dofile("./SKRANInfo.lua")
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/devid100/SKRAN/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1853574370,1910131222,1853574370,897897181}   
...
if tonumber(user_id) == tonumber(1853574370) then  
var = true
elseif tonumber(user_id) == tonumber(1910131222) then
var = true
elseif tonumber(user_id) == tonumber(897897181) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'السكران'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "ELMAGD3")
...
local SCKRAN_Msg = ''  
if msgs < 100 then 
SCKRAN_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
SCKRAN_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
SCKRAN_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
SCKRAN_Msg = 'متفاعل' 
elseif msgs < 1200 then 
SCKRAN_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
SCKRAN_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
SCKRAN_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
SCKRAN_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
SCKRAN_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
SCKRAN_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
SCKRAN_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
SCKRAN_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
SCKRAN_Msg = 'رب التفاعل'  
end 
return SCKRAN_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼 ¹𝕊𝕂ℝ𝔸ℕ ¹")  
...
function plugin_SCKRAN(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.SCKRAN and msg then
pre_msg = plugin.SCKRAN(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceSCKRAN(msg,data) -- بداية العمل
if msg then
...
Namebot = (database:get(bot_id..'Name:Bot') or 'السكران')
agwa = dofile("./SKRANInfo.lua").UserName
 agwa = agwa:gsub("%@", "")
local inline = {
{{text = '  مطور البوت 𖠕 ',url="t.me/"..agwa}},
{{text = 'اضف البوت الي مجموعتك 𖠕' ,url="t.me/"..dofile("./SKRANInfo.lua").botUserName.."?startgroup=start"}}, 
{{text = '𝘾𝙃𝘼𝙉𝙉𝙀𝙇', url="t.me/ELMAGD3"}},
} 
local Keyboard = {
{'𓆩| ıl`𝕊𝕂ℝ𝔸ℕ ´lı |𓆪'},
...
{'𓆩| ıl`𝕊𝕂ℝ𝔸ℕ ´lı |𓆪'},
{'ايدي','العاب السكران','سورس','تغير الايدي'},
{'𓆩| ıl`𝕊𝕂ℝ𝔸ℕ ´lı |𓆪'},
...
send(msg.chat_id_, msg.id_,SCKRAN_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf SCKRAN.lua')
os.execute('wget https://raw.githubusercontent.com/devid100/SKRAN/main/SCKRAN.lua')
send(msg.chat_id_, msg.id_,'◉ تم تحديث السورس')
dofile('SCKRAN.lua')  
end
if text == 'الاصدار ' and sudo2(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ◉ اصدار سورس السكران { s: 6.7}')
end
if text == 'ابوالمجد مالك السورس' and sudo2(msg) then
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[DEV Devid](t.me/ABO_ELMAGD2)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽𝔸𝔹𝕆 𝔼𝕃𝕄𝔸𝔾𝔻 𝅘𝅥𝅯 ₎ ✤ ', url="t.me/ABO_ELMAGD2"}}, 
} 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ✤ ⁽𝔻ℝ ℝ𝔸𝔽𝔸𝕋 ₎ ✤ ',url="t.me/Dr_Rafaat"}},
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/ELMAGD3"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/ELMAGD2_BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  ❨ TＷＡＳＯＬ ◉  ❩ ', url="t.me/ELMAGD2_BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
else
...
send(msg.chat_id_, msg.id_,'◉  عدد الجروبات الان ← { '..#group..' }'..SCKRANk..''..SCKRAN..'\n◉  الان عدد الجروبات الحقيقي ← { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ◉ العضو ← ['..result.title_..'](t.me/'..(username or 'ELMAGD3')..')'
status  = '\n ◉ تم ترقيته مطور'
...
usertext = '\n ◉ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'ELMAGD3')..')'
status  = '\n ◉ تم ترقيته مطور'
...
local SCKRAN1_Msg = database:get(bot_id.."SCKRAN1:Add:Filter:Rp2"..text..msg.chat_id_)   
if SCKRAN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELMAGD3')..') \n ◉ '..SCKRAN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if SCKRAN_Msg and not Special(msg) then  
local SCKRAN_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if SCKRAN_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◉ ["..SCKRAN_Msg.."] \n")
else
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/ELMAGD3)}\n ◉ ["..SCKRAN_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◉ عذرا ← {["..data.first_name_.."](T.ME/ELMAGD3)}\n ◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('rm -rf SCKRAN.lua')
os.execute('wget https://raw.githubusercontent.com/devid100/SKRAN/main/SCKRAN.lua')
os.execute('wget https://raw.githubusercontent.com/devid100/SKRAN/main/library')
os.execute('wget https://raw.githubusercontent.com/devid100/SKRAN/main/File_Bot')
send(msg.chat_id_, msg.id_,' ◉ تم تحديث السورس')
dofile('SCKRAN.lua')  
end
...
database:sadd(bot_id.."SCKRAN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SCKRAN:blocname"..msg.chat_id_)
...
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."SCKRAN:blocname"..msg.chat_id_) or ""
...
database:set(bot_id.."SCKRAN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."SCKRAN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."SCKRAN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."SCKRAN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."SCKRAN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."SCKRAN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."SCKRAN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."SCKRAN:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."SCKRAN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."SCKRAN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "◉ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "ELMAGD3")..")\n◉ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."SCKRAN:teh"..msg.chat_id_).."} بجانب اسمك\n◉ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local SCKRANChengName = database:get(bot_id.."SCKRAN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if SCKRANChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..SCKRANChengName..']')
database:del(bot_id.."SCKRAN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if SCKRANChengName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
database:set(bot_id.."SCKRAN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local SCKRANChengUserName = database:get(bot_id.."SCKRAN:Cheng:UserName"..data.id_)
if not data.username_ then 
if SCKRANChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..SCKRANChengUserName..']')
database:del(bot_id.."SCKRAN:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if SCKRANChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."SCKRAN:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local SCKRANChengPhoto = database:get(bot_id.."SCKRAN:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if SCKRANChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."SCKRAN:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if SCKRANChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."SCKRAN:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
if text == 'عبدو' or text == 'عبدلله' then
local msg_id = msg.id_/2097152/0.5
local Text = [[
 المبرمج عبدو 
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹𝕄ℝ 𝔸𝔹𝔻𝕆 ¹˼ 𓌺 ',url="t.me/ABNRASHIDYADOLH"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ABNRASHIDYADOLH&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end

if text == 'رافت' or text == "رافت" then
local msg_id = msg.id_/2097152/0.5
local Text = [[
 المبرمج رافت
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '  𓌹 ˹𝔻ℝ ℝ𝔸𝔽𝔸𝕋 ¹˼ 𓌺 ',url="t.me/Dr_Rafaat"}},}
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Dr_Rafaat&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/ABO_ELMAGD2"},{text = ' ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ',url="t.me/Dr_Rafaat"}},
{{text = '  ◍ D𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁 𖣌 ', url="t.me/ABNRASHIDYADOLH"}},
{{text = '   ◍ M𝚈 𝙲𝙷𝙰𝙽𝙽𝙴𝙻𝚂 𖣌  ', url="t.me/ELMAGD3"}},
}
https.request("https://api.telegram.org/bot"..token..'/sendanimation?chat_id=' .. msg.chat_id_ .. '&animation=https://t.me/ELMAGD3/6&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
{{text = '𖣘⁽𝕄ℝ 𝔸𝔹𝔻𝕆 ₎𖣘', url="http://t.me/ABNRASHIDYADOLH"}},
{{text = '  𖣘 ⁽𝔸𝔹𝕆 𝔼𝕃𝕄𝔸𝔾𝔻 𝅘𝅥𝅯 ₎ 𖣘 ',url="t.me/ABO_ELMAGD2"}},
{{text = '  𖣘 ⁽𝔻ℝ ℝ𝔸𝔽𝔸𝕋 ₎ 𖣘 ',url="t.me/Dr_Rafaat"}}
}
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))  
end
...
local Text = [[
 ◉ اهلا بك في سورس السكران الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني  ◉ 
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '  𖣘 ⁽𝔸𝔹𝕆 𝔼𝕃𝕄𝔸𝔾𝔻 𝅘𝅥𝅯 ₎ 𖣘 ',url="t.me/ABO_ELMAGD2"}},
...
"سؤال ينرفزك ؟ ", 
" هل يعجبك سورس السكران ؟؟ ", 
" اكثر ممثل تحبه ؟ ", 
"قد تخيلت شي في بالك وصار ؟ ", 
"شيء عندك اهم من الناس ؟ ", 
"تفضّل النقاش الطويل او تحب الاختصار ؟ ", 
"وش أخر شي ضيعته؟ ", 
"اي رايك في سورس السكران ؟ ", 
"كم مره حبيت؟ ", 
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '  𖣘 ⁽SＯＵＲＣＥ₎ 𖣘', url="t.me/ELMAGD3"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ ¹❳⊷━━━━⩺' then
local Text = [[ 
◉من أحسن السورسات على التليجرام سورس السكران◉
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𖣘⁽𝕄ℝ 𝔸𝔹𝔻𝕆 ₎𖣘', url="t.me/ABNRASHIDYADOLH"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == 'العاب السكران' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 ◉ اهلا في قائمه الالعاب المتطوره سورس السكران  ◉ 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELMAGD3')..') \n ◉ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ◉ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ELMAGD3')..') \n ◉ تـم قفـل التاك بالكتم ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه »>['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ELMAGD3')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(1910131222) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(897897181) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1853574370) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مالك السورس السكران عام")
return false 
end
...
if result.id_ == tonumber(1910131222) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1853574370) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مالك السورس السكران عام \n")
return false 
end
...
if tonumber(userid) == tonumber(1910131222) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(1853574370) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع كتم مالك السورس السكران عام")
return false 
end
...
if result.id_ == tonumber(1853574370) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك كتم مالك السورس السكران عام \n")
return false 
end
if result.id_ == tonumber(1910131222) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك كتم مبرمج السورس \n")
...
if sudo2(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/devid100/SKRAN/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات السكران\n ◉ ملفات السورس ↓\n≪◤━───━??𝗼𝗼𝗼𝗻━───━◥≫\n\n"
local TextE = "\n⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ ¹❳⊷━━━━⩺\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { ✖ } ملف معطل\n ◉ قناة سورس السكران ↓\n".." ◉ [اضغط هنا لدخول](t.me/ELMAGD3) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/devid100/SKRAN/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('SCKRAN.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس السكران \n") 
end
return false
end
...
if text == ("مسح قائمه السكران") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه السكران')
return false
end

if text == 'قائمه السكران' and Sudo(msg) then
...
if #list == 0 then
t = " ◉ لا يوجد احد في قائمه السكران"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
if text == ("رفع السكران") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text and text:match("^رفع السكران @(.*)$") and Sudo(msg) then
local username = text:match("^رفع السكران @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text and text:match("^رفع السكران (%d+)$") and Sudo(msg) then
local userid = text:match("^رفع السكران (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text == ("تنزيل السكران") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text and text:match("^تنزيل السكران @(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل السكران @(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
if text and text:match("^تنزيل السكران (%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل السكران (%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local ELMAGD3 = database:get(bot_id..'text:ch:user')
if ELMAGD3 then
send(msg.chat_id_, msg.id_,'['..ELMAGD3..']')
...
local UserName = (b.username_ or "SRC-SCKRAN")
...
function Function_SCKRAN(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_SCKRAN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_SCKRAN, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ◉ لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'ELMAGD3')..')'
status  = '\n ◉ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ◉ العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ◉ العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'ELMAGD3')..')'
...
database:set(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ◉ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."SCKRAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."SCKRAN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ◉ تم منع الكلمه مع التحذير")  
database:del(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."SCKRAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."SCKRAN1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."SCKRAN1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ◉ ارسل الكلمه الان")  
database:set(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SCKRAN1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."SCKRAN1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."SCKRAN1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."SCKRAN1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."SCKRAN1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."SCKRAN1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ◉ قائمة المنع \n⩹━━━━⊶❲¹𝕊𝕂ℝ𝔸ℕ ¹❳⊷━━━━⩺\n"
for k,v in pairs(list) do  
local SCKRAN_Msg = database:get(bot_id.."SCKRAN1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ← {"..SCKRAN_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ◉ العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'ELMAGD3')..')'..'\n ◉ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n ◉ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:SCKRAN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:SCKRAN:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:SCKRAN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"◉ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:SCKRAN:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:SCKRAN:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:SCKRAN:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:SCKRAN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:SCKRAN:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:SCKRAN:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:SCKRAN:List:Rd:Sudo")
end
...
database:set(bot_id.."ELMAGD3:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,' تم تفعيل الانستا')
database:set(bot_id.."ELMAGD3:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."ELMAGD3:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."ELMAGD3:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"◉تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."ELMAGD3:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."ELMAGD3:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس السكران يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:SCKRAN:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"◉ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:SCKRAN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SCKRAN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:SCKRAN:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:SCKRAN:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"◉تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:SCKRAN:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'السكران').." غادر" or text == 'غادر' then  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'السكران').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'السكران')
local SCKRAN_Msg = {
'ننعم يروحي 😻💙',
'نعم يا قلب  '..Namebot..'',
...
send(msg.chat_id_, msg.id_,'['..SCKRAN_Msg[math.random(#SCKRAN_Msg)]..']') 
return false
end
if text == "بوت" then  
local msg_id = msg.id_/2097152/0.5
...
local Text = [[
 ]]..SCKRAN_Msg[math.random(#SCKRAN_Msg)]..[[ 
 
]]

 us = dofile("./SKRANInfo.lua").botUserName
 agwa = dofile("./SKRANInfo.lua").UserName
 agwa = agwa:gsub("%@", "")
keyboard = {} 
keyboard.inline_keyboard = {
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ELMAGD3')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
SCKRANdx(msg.chat_id_, msg.id_, ' ◉ ايدي المجموعة ← ( '..msg.chat_id_..' )\n ◉ عدد الادمنيه ← ( *'..data.administrator_count_..' )*\n ◉ عدد المحظورين ← ( *'..data.kicked_count_..' )*\n ◉ عدد الاعضاء ← ( *'..data.member_count_..' )*\n', 'md') 
end 
...
{
{text = ' 𝚂𝙾𝚄𝚁𝙲𝙴 𝙰𝚅𝙸𝚁𝙰', url="t.me/ELMAGD3"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'السكران')
...
SCKRAN = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(SCKRAN)
...
--------------------------------------------------------------------------------------------------------------
SourceSCKRAN(data.message_,data)
plugin_SCKRAN(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local SCKRANAbot = database:get(bot_id.."SCKRAN1:Add:Filter:Rp2"..text..result.chat_id_)   
if SCKRANAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ◉ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ◉ ["..SCKRANAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local SCKRAN1_Msg = database:get(bot_id.."SCKRAN1:Add:Filter:Rp2"..text..result.chat_id_)   
if SCKRAN1_Msg then    
send(msg.chat_id_, msg.id_," ◉ "..SCKRAN1_Msg)
